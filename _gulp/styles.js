...
gulp.task('styles', function(callback) {
	runSequence(
		...
		'editor-clear-generated',
		callback
	);
});

gulp.task('editor-generate', function() {
	return gulp.src(config.inputFiles.sitecore.itcss)
		.pipe(gsgc(config.inputFiles.sitecore.main, {}, {disableContents: true }))
...
gulp.task('editor-compile', function() {
	return gulp.src(config.inputFiles.sitecore.main)
	...
	.pipe(rename(config.outputFiles.styles.editor))
...
gulp.task('editor-clear-generated', function() {
	return del(config.inputFiles.sitecore.main);
});
